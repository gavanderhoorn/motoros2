...
typedef enum
{
    ...
    SUBCODE_FAIL_INIT_SERVICE_LIST_JOBS,
    SUBCODE_FAIL_INIT_SERVICE_GET_JOB,
    SUBCODE_FAIL_INIT_SERVICE_PUT_JOB,
    SUBCODE_FAIL_INIT_SERVICE_DELETE_JOB,
    SUBCODE_FAIL_ADD_SERVICE_LIST_JOBS,
    SUBCODE_FAIL_ADD_SERVICE_GET_JOB,

    SUBCODE_FAIL_ADD_SERVICE_PUT_JOB,
    SUBCODE_FAIL_ADD_SERVICE_DELETE_JOB,
