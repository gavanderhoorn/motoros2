...
typedef enum
{
    ...
    SUBCODE_FAIL_INIT_SERVICE_GET_INFORM_JOB,
    SUBCODE_FAIL_INIT_SERVICE_PUT_INFORM_JOB,
    SUBCODE_FAIL_INIT_SERVICE_DELETE_INFORM_JOB,
    SUBCODE_FAIL_ADD_SERVICE_LIST_INFORM_JOBS,
    SUBCODE_FAIL_ADD_SERVICE_GET_INFORM_JOB,

    SUBCODE_FAIL_ADD_SERVICE_PUT_INFORM_JOB,
    SUBCODE_FAIL_ADD_SERVICE_DELETE_INFORM_JOB,
